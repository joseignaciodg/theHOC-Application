...
host = '192.168.138.45' #make server socket ip public with public ip of the connected internet 2.45.7.150 (WiFi Vodafone) 176.83.20.98 (AndroidAP)
port = 1234		   #Set up static port forwarding in your router's configuration. The idea is that you tell it "if someone comes looking for port 1234, always send them to machine 192.168.1.64 for example".
